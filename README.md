...
Проект в активной разработке. Движок готов; расширение Preview работает сквозным срезом; главное приложение-менеджер имеет рабочее окно с тремя вкладками и записывает настройки в App Group — расширение Preview их уже читает.

| Подсистема | Статус |
|---|---|
| Движок рендеринга (`QuickLookersEngine`) | готов |
| Расширение QuickLook Preview | тонкий срез работает (swift/json/js, тема из настроек) |
